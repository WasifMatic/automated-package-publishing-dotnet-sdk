// <copyright file="PaypalServerClient.cs" company="APIMatic">
...
using PaypalServer.Standard.Controllers;
using PaypalServer.Standard.Http.Client;
using PaypalServer.Standard.Logging;
using System;
...
namespace PaypalServer.Standard
{
    ...
    /// </summary>
    public sealed class PaypalServerClient : IConfiguration
    {
        ...
        /// <summary>
        /// Creates an object of the PaypalServerClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> PaypalServerClient.</returns>
        internal static PaypalServerClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("PAYPAL_SERVER_STANDARD_ENVIRONMENT");
            string oAuthClientId = System.Environment.GetEnvironmentVariable("PAYPAL_SERVER_STANDARD_O_AUTH_CLIENT_ID");
            string oAuthClientSecret = System.Environment.GetEnvironmentVariable("PAYPAL_SERVER_STANDARD_O_AUTH_CLIENT_SECRET");
        ...
        /// </summary>
        /// <returns> PaypalServerClient.</returns>
        public static PaypalServerClient FromConfiguration(IConfigurationSection configuration) =>
        ...
        {
            private Environment _environment = PaypalServer.Standard.Environment.Sandbox;
            ...
            /// </summary>
            /// <returns>PaypalServerClient.</returns>
            public PaypalServerClient Build()
            {
            ...
            {
                var builder = new Builder();
                var options = config.Get<PaypalServerClientOptions>();
