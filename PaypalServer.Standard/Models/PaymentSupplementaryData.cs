...
namespace PaypalServer.Standard.Models
{
    ...
    public class PaymentSupplementaryData
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PaymentSupplementaryData other &&
                (this.RelatedIds == null && other.RelatedIds == null ||
                 this.RelatedIds?.Equals(other.RelatedIds) == true);
        }
        ...
        {
            toStringOutput.Add($"RelatedIds = {(this.RelatedIds == null ? "null" : this.RelatedIds.ToString())}");
        }
    }
}