...
| `Id` | `string` | Optional, Read-only | The PayPal-generated ID for the captured payment. |
...
| `FinalCapture` | `bool?` | Optional, Read-only | Indicates whether you can make additional captures against the authorized payment. Set to `true` if you do not intend to capture additional payments against the authorization. Set to `false` if you intend to capture additional payments against the authorization.<br><br>**Default**: `false` |
...
PaymentsCapture paymentsCapture = new PaymentsCapture
{
