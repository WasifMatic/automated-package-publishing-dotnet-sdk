...
# Financial Institution Identification 2

## Structure

`FinancialInstitutionIdentification2`
...
| `PostalAddress` | [`FinancialInstitutionIdentification2PostalAddress`](../../doc/models/containers/financial-institution-identification-2-postal-address.md) | Optional | This is a container for one-of cases. |
