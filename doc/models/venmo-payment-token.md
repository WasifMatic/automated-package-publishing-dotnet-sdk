...
| `UserName` | `string` | Optional | The Venmo username, as chosen by the user.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `50`, *Pattern*: `^[-a-zA-Z0-9_]*$` |
...
VenmoPaymentToken venmoPaymentToken = new VenmoPaymentToken
{
