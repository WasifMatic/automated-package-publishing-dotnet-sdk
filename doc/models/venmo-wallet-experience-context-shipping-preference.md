...
VenmoWalletExperienceContextShippingPreference venmoWalletExperienceContextShippingPreference = VenmoWalletExperienceContextShippingPreference.SetProvidedAddress;
```
