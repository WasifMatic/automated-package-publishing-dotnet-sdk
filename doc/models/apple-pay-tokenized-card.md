...
| `CardType` | [`CardBrand?`](../../doc/models/card-brand.md) | Optional, Read-only | The card brand or network. Typically used in the response.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[A-Z_]+$` |
...
ApplePayTokenizedCard applePayTokenizedCard = new ApplePayTokenizedCard
{
    Name = "name8",
    Number = "number4",
    Expiry = "expiry6",
