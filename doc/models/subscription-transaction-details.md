...
| `PayerName` | [`SubscriptionPayerName`](../../doc/models/subscription-payer-name.md) | Optional | The name of the party. |
...
SubscriptionTransactionDetails subscriptionTransactionDetails = new SubscriptionTransactionDetails
{
    Id = null,
