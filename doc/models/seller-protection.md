...
| `DisputeCategories` | [`List<DisputeCategory>`](../../doc/models/dispute-category.md) | Optional, Read-only | An array of conditions that are covered for the transaction. |
...
SellerProtection sellerProtection = new SellerProtection
{
};
```
