...
Input structure for the method AuthorizeOrder
...
|  --- | --- | --- | --- |
| `Id` | `string` | Required | The ID of the order for which to authorize.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36`, *Pattern*: `^[A-Z0-9]+$` |
...
| `Body` | [`OrderAuthorizeRequest`](../../doc/models/order-authorize-request.md) | Optional | - |
