...
| `PostalAddress` | [`OwnerPostalAddress`](../../doc/models/containers/owner-postal-address.md) | Optional | This is a container for one-of cases. |
...
```json
{
  ...
  "country_of_residence": "country_of_residence8"
}
```
