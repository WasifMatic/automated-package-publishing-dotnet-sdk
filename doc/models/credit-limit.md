...
| `Amount` | `string` | Optional | **Constraints**: *Maximum Length*: `19`, *Pattern*: `^0*(([0-9]{0,13}\.[0-9]{1,5})\|([0-9]{0,14}\.[0-9]{1,4})\|([0-9]{0,15}\.[0-9]{1,3})\|([0-9]{0,16}\.[0-9]{1,2})\|([0-9]{0,17}\.[0-9]{1,1})\|0*\|([0-9]{0,18}))$` |
