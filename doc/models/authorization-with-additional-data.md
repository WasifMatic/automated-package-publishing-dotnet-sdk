...
| `Id` | `string` | Optional, Read-only | The PayPal-generated ID for the authorized payment. |
...
AuthorizationWithAdditionalData authorizationWithAdditionalData = new AuthorizationWithAdditionalData
{
