...
| `Liefery` | liefery. |
| `StreckTransport` | Streck Transport. |
...
| `UsOldDominion` | Old Dominion Freight Line. |
...
| `GlobalEstes` | Estes Express Lines. |
...
| `JtexpressVn` | J&T Express Vietnam. |
...
| `Mazet` | Groupe Mazet. |
| `FirstLogisticsApi` | First Logistics. |
...
| `Payo` | Payo. |
| `WhistlSftp` | Whistl. |
| `IntexDe` | INTEX Paketdienst GmbH. |
| `Trans2U` | Trans2u. |
