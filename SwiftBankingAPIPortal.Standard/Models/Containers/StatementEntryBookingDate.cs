// <copyright file="StatementEntryBookingDate.cs" company="APIMatic">
...
namespace SwiftBankingAPIPortal.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<StatementEntryBookingDate>),
        new System.Type[] {
            typeof(MStringCase)
        },
        true
    )]
    public abstract class StatementEntryBookingDate
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The StatementEntryBookingDate instance, wrapping the provided string value.
        /// </returns>
        public static StatementEntryBookingDate FromString(string mString)
        {
        ...
        private sealed class MStringCase : StatementEntryBookingDate, ICaseValue<MStringCase, string>
        {
            public string Value;
