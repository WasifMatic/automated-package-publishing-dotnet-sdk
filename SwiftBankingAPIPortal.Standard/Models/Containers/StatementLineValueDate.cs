// <copyright file="StatementLineValueDate.cs" company="APIMatic">
...
namespace SwiftBankingAPIPortal.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<StatementLineValueDate>),
        new System.Type[] {
            typeof(MStringCase)
        },
        true
    )]
    public abstract class StatementLineValueDate
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The StatementLineValueDate instance, wrapping the provided string value.
        /// </returns>
        public static StatementLineValueDate FromString(string mString)
        {
        ...
        private sealed class MStringCase : StatementLineValueDate, ICaseValue<MStringCase, string>
        {
            public string Value;
