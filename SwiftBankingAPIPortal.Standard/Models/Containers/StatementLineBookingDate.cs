// <copyright file="StatementLineBookingDate.cs" company="APIMatic">
...
namespace SwiftBankingAPIPortal.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<StatementLineBookingDate>),
        new System.Type[] {
            typeof(MStringCase)
        },
        true
    )]
    public abstract class StatementLineBookingDate
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The StatementLineBookingDate instance, wrapping the provided string value.
        /// </returns>
        public static StatementLineBookingDate FromString(string mString)
        {
        ...
        private sealed class MStringCase : StatementLineBookingDate, ICaseValue<MStringCase, string>
        {
            public string Value;
