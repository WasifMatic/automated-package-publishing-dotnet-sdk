// <copyright file="StatementEntryValueDate.cs" company="APIMatic">
...
namespace SwiftBankingAPIPortal.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<StatementEntryValueDate>),
        new System.Type[] {
            typeof(MStringCase)
        },
        true
    )]
    public abstract class StatementEntryValueDate
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The StatementEntryValueDate instance, wrapping the provided string value.
        /// </returns>
        public static StatementEntryValueDate FromString(string mString)
        {
        ...
        private sealed class MStringCase : StatementEntryValueDate, ICaseValue<MStringCase, string>
        {
            public string Value;
