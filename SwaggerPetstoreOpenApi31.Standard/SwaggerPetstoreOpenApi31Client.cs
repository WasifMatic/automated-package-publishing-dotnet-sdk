// <copyright file="SwaggerPetstoreOpenApi31Client.cs" company="APIMatic">
...
namespace SwaggerPetstoreOpenApi31.Standard
{
    ...
    /// </summary>
    public sealed class SwaggerPetstoreOpenApi31Client : IConfiguration
    {
        ...
        private const string userAgent = "DotNet-SDK/1.0.26 (OS: {os-info}, Engine: {engine}/{engine-version})";
        private readonly HttpCallback httpCallback;
        private readonly Lazy<PetApi> pet;
        private readonly Lazy<StoreApi> store;
        private readonly Lazy<UserApi> user;

        private SwaggerPetstoreOpenApi31Client(
        ...
        /// <summary>
        /// Creates an object of the SwaggerPetstoreOpenApi31Client using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> SwaggerPetstoreOpenApi31Client.</returns>
        internal static SwaggerPetstoreOpenApi31Client CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("SWAGGER_PETSTORE_OPEN_API_31_STANDARD_ENVIRONMENT");
            string oauthClientId = System.Environment.GetEnvironmentVariable("SWAGGER_PETSTORE_OPEN_API_31_STANDARD_OAUTH_CLIENT_ID");
            string oauthRedirectUri = System.Environment.GetEnvironmentVariable("SWAGGER_PETSTORE_OPEN_API_31_STANDARD_OAUTH_REDIRECT_URI");
            string apiKey = System.Environment.GetEnvironmentVariable("SWAGGER_PETSTORE_OPEN_API_31_STANDARD_API_KEY");
        ...
        /// </summary>
        /// <returns> SwaggerPetstoreOpenApi31Client.</returns>
        public static SwaggerPetstoreOpenApi31Client FromConfiguration(IConfigurationSection configuration) =>
        ...
        {
            private Environment _environment = SwaggerPetstoreOpenApi31.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>SwaggerPetstoreOpenApi31Client.</returns>
            public SwaggerPetstoreOpenApi31Client Build()
            {
                ...
                return new SwaggerPetstoreOpenApi31Client(
                    _environment,
                    _petstoreAuthModel,
                    _apiKeyModel,
                    _httpCallback,
            ...
            {
                var builder = new Builder();
                var options = config.Get<SwaggerPetstoreOpenApi31ClientOptions>();
        ...
        public class SwaggerPetstoreOpenApi31ClientOptions
        {
